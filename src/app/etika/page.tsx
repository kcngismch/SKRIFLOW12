  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#080D1D] text-[#FFF9EE]">
      ...
      <main className="flex-1 pb-20">
        {/* Breadcrumb Bar */}
        <div className="border-b border-[#273352]/60 bg-[#080D1D]/60">
          <div className="mx-auto flex max-w-6xl items-center gap-2 px-4 py-3 text-xs text-[#AAB4D0] sm:px-6 lg:px-8">
            <Link
              href="/"
              className="hover:text-[#FFF9EE] transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#2959FF] rounded"
            >
              Beranda
            </Link>
            <span className="text-[#273352]">/</span>
            <span className="text-[#FFF9EE] font-medium">Deklarasi AI &amp; Etika</span>
          </div>
        </div>

        {/* Hero Section */}
        <section className="relative overflow-hidden border-b border-[#273352] py-16 sm:py-20 lg:py-24">
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 relative">
            <div className="max-w-3xl">
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#70E1B6]/30 bg-[#70E1B6]/10 px-3.5 py-1.5 text-xs font-semibold text-[#70E1B6]">
                <ShieldCheck className="h-4 w-4 text-[#70E1B6]" aria-hidden="true" />
                <span>KOMITMEN INTEGRITAS AKADEMIK</span>
              </div>

              <h1 className="text-3xl font-black tracking-tight text-[#FFF9EE] sm:text-4xl lg:text-5xl leading-tight">
                Deklarasi AI &amp; Prinsip Etika Penelitian
              </h1>

              <p className="mt-5 text-base text-[#AAB4D0] sm:text-lg leading-relaxed">
                Posisi resmi SKRIFLOW tentang pemanfaatan Artificial Intelligence dalam penulisan skripsi:{" "}
                <span className="text-[#FFF9EE] font-medium">
              ...
              <div className="mt-8 flex flex-wrap gap-2.5">
                <span className="inline-flex items-center gap-1.5 rounded-lg border border-[#273352] bg-[#11182D] px-3 py-1.5 text-xs font-medium text-[#FFF9EE]">
        ...
        <section className="border-b border-[#273352] py-16 sm:py-20">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
              <div className="lg:col-span-5">
                <div className="sticky top-24 space-y-4">
                  <div className="inline-flex items-center gap-2 rounded-md border border-[#2959FF]/30 bg-[#2959FF]/10 px-3 py-1 text-xs font-semibold text-[#2959FF]">
                    <Scale className="h-3.5 w-3.5" aria-hidden="true" />
                    <span>FILOSOFI PRODUK</span>
                  </div>
                  <h2 className="text-2xl font-bold tracking-tight text-[#FFF9EE] sm:text-3xl">
                    Skripsi Adalah Bukti Kemampuan Riset, Bukan Sekadar Naskah Jadi
                  </h2>
                  <p className="text-sm leading-relaxed text-[#AAB4D0]">
                  ...
                  <p className="text-sm leading-relaxed text-[#AAB4D0]">
                    ...
                    <strong className="text-[#FFF9EE]">empat batasan keras (red lines)</strong> yang tidak akan pernah dilanggar
                    oleh sistem kami.
                  </p>
                </div>
              </div>
              ...
              <div className="lg:col-span-7">
                <div className="space-y-4">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-[#FF6F61]">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {RED_LINES.map((item, idx) => (
                      <div
                        key={idx}
                        className="rounded-xl border border-[#273352] bg-[#0D1527] p-5 transition-all hover:border-[#FF6F61]/40"
                      >
                        <div className="flex items-start gap-3.5">
                          <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[#FF6F61]/15 text-[#FF6F61] border border-[#FF6F61]/30">
        ...
        <section className="border-b border-[#273352] bg-[#080D1D] py-16 sm:py-20">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-3 text-2xl font-bold tracking-tight text-[#FFF9EE] sm:text-3xl">
                Kenapa Setiap Output AI Wajib Diverifikasi ke Sumber Primer?
              </h2>
              <p className="mt-4 text-sm leading-relaxed text-[#AAB4D0] sm:text-base">
            ...
            <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
              {/* Card 1 */}
              <div className="rounded-xl border border-[#273352] bg-[#0D1527] p-6">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#FF6F61]/15 text-[#FF6F61] border border-[#FF6F61]/30 mb-4">
                  <AlertTriangle className="h-5 w-5" aria-hidden="true" />
                </div>
                <h3 className="text-base font-bold text-[#FFF9EE]">Ilusi Referensi Valid</h3>
                <p className="mt-2 text-xs leading-relaxed text-[#AAB4D0]">
              ...
              <div className="rounded-xl border border-[#273352] bg-[#0D1527] p-6">
                ...
                <h3 className="text-base font-bold text-[#FFF9EE]">Bahaya Blind Reliance</h3>
                <p className="mt-2 text-xs leading-relaxed text-[#AAB4D0]">
              ...
              {/* Card 3 */}
              <div className="rounded-xl border border-[#273352] bg-[#0D1527] p-6">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#70E1B6]/15 text-[#70E1B6] border border-[#70E1B6]/30 mb-4">
                  <CheckCircle2 className="h-5 w-5" aria-hidden="true" />
                </div>
                <h3 className="text-base font-bold text-[#FFF9EE]">Standar Verifikasi Primer</h3>
                <p className="mt-2 text-xs leading-relaxed text-[#AAB4D0]">
            ...
            <div className="mt-8 rounded-xl border border-[#273352] bg-[#11182D] p-6">
              <h4 className="flex items-center gap-2 text-sm font-bold text-[#FFF9EE]">
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3 text-xs">
                <div className="space-y-1">
                  <span className="font-semibold text-[#70E1B6]">1. Periksa Akses URL &amp; DOI</span>
                ...
                <div className="space-y-1">
                  <span className="font-semibold text-[#70E1B6]">2. Cek Jenis Sumber &amp; Reputasi</span>
                  <p className="text-[#AAB4D0] leading-relaxed">
                ...
                <div className="space-y-1">
                  <span className="font-semibold text-[#70E1B6]">3. Baca Konteks Asli Temuan</span>
                  <p className="text-[#AAB4D0] leading-relaxed">
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
              <div className="lg:col-span-6 space-y-4">
                ...
                <div className="space-y-3 pt-2">
                  <div className="flex items-start gap-3 rounded-lg border border-[#273352] bg-[#0D1527] p-4 text-xs">
                    <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#2959FF]/20 text-[10px] font-bold text-[#70E1B6]">
                      §4
                    </span>
                    <div>
                      <strong className="text-[#FFF9EE]">Pasal 4 — Kewajiban Verifikasi Mandiri:</strong>
                      <p className="mt-1 text-[#AAB4D0] leading-relaxed">
                  ...
                  <div className="flex items-start gap-3 rounded-lg border border-[#273352] bg-[#0D1527] p-4 text-xs">
                    ...
                    <div>
                      <strong className="text-[#FFF9EE]">Pasal 5 — Larangan Kepengarangan (Authorship):</strong>
                      <p className="mt-1 text-[#AAB4D0] leading-relaxed">
                  ...
                  <div className="flex items-start gap-3 rounded-lg border border-[#273352] bg-[#0D1527] p-4 text-xs">
                    ...
                    <div>
                      <strong className="text-[#FFF9EE]">Transparansi &amp; Pengakuan Terbuka:</strong>
                      <p className="mt-1 text-[#AAB4D0] leading-relaxed">
              ...
              <div className="lg:col-span-6 space-y-4">
                <div className="inline-flex items-center gap-2 rounded-md border border-[#70E1B6]/30 bg-[#70E1B6]/10 px-3 py-1 text-xs font-semibold text-[#70E1B6]">
                ...
                <div className="space-y-3 pt-2">
                  <div className="rounded-lg border border-[#273352] bg-[#11182D] p-4">
                    <h4 className="text-xs font-bold text-[#FFF9EE] flex items-center gap-2">
                      <Sparkles className="h-4 w-4 text-[#70E1B6]" aria-hidden="true" />
                      Jejak Proses &amp; Riwayat Prompt (Audit Trail)
                    </h4>
                    <p className="mt-1.5 text-xs text-[#AAB4D0] leading-relaxed">
        ...
        <section className="border-b border-[#273352] bg-[#080D1D] py-16 sm:py-20">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto">
              <div className="inline-flex items-center gap-2 rounded-md border border-[#273352] bg-[#11182D] px-3 py-1 text-xs font-semibold text-[#AAB4D0]">
                <span>RINGKASAN TEGAS</span>
              </div>
              <h2 className="mt-3 text-2xl font-bold tracking-tight text-[#FFF9EE] sm:text-3xl">
                Yang Kami TIDAK Lakukan vs Yang Kami Bantu
              </h2>
              <p className="mt-3 text-xs text-[#AAB4D0] sm:text-sm leading-relaxed">
            ...
            <div className="mt-10 overflow-hidden rounded-xl border border-[#273352] bg-[#0D1527]">
              {/* Table Header */}
              <div className="grid grid-cols-1 md:grid-cols-2 border-b border-[#273352] bg-[#11182D] text-xs font-bold uppercase tracking-wider">
                <div className="flex items-center gap-2 p-4 text-[#FF6F61] border-b md:border-b-0 md:border-r border-[#273352]">
                  <XCircle className="h-4 w-4 shrink-0" aria-hidden="true" />
                  <span>Yang Kami TIDAK Lakukan (Red Lines)</span>
                </div>
                <div className="flex items-center gap-2 p-4 text-[#70E1B6]">
              ...
              {/* Table Rows */}
              <div className="divide-y divide-[#273352]/70 text-xs">
                {COMPARISON_ITEMS.map((item, idx) => (
                  <div key={idx} className="grid grid-cols-1 md:grid-cols-2 transition-colors hover:bg-[#11182D]/50">
                    <div className="flex items-start gap-3 p-4 border-b md:border-b-0 md:border-r border-[#273352]/70 text-[#AAB4D0]">
                      <span className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-[#FF6F61]/10 text-[#FF6F61] font-mono text-[10px]">
                        ✕
                      </span>
                      <span className="leading-relaxed">{item.notDone}</span>
                    </div>
                    <div className="flex items-start gap-3 p-4 text-[#FFF9EE]">
                      <span className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-[#70E1B6]/10 text-[#70E1B6] font-mono text-[10px]">
                        ✓
                      </span>
                      <span className="leading-relaxed text-[#AAB4D0]">{item.supported}</span>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <section className="border-b border-[#273352] py-16 sm:py-20">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-sm leading-relaxed text-[#AAB4D0]">
            ...
            <div className="mt-8 rounded-xl border border-[#273352] bg-[#0D1527] p-6 sm:p-8">
              <div className="flex items-center justify-between border-b border-[#273352] pb-4 mb-5">
                <span className="text-xs font-bold uppercase tracking-wider text-[#70E1B6] flex items-center gap-2">
              ...
              <div className="space-y-4 font-mono text-xs leading-relaxed text-[#AAB4D0] bg-[#080D1D] p-5 rounded-lg border border-[#273352]/80 select-all">
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>
                    <strong className="text-[#FFF9EE]">Eksplorasi Ide &amp; Pemetaan Fenomena:</strong> Menggunakan bantuan AI
                  ...
                  <li>
                    <strong className="text-[#FFF9EE]">Penelusuran Literatur:</strong> Menggunakan NotebookLM dan alat bantu berbasis
                  ...
                  <li>
                    <strong className="text-[#FFF9EE]">Penyempurnaan Bahasa &amp; Kohesi:</strong> AI dimanfaatkan sebatas pengecekan
                    tata bahasa dan kelancaran alur kalimat pada draf yang ditulis sendiri oleh penulis.
                  </li>
                </ol>
                <p className="pt-2 border-t border-[#273352]/70 text-[#FFF9EE]">
              ...
              <div className="mt-4 flex items-start gap-2.5 text-xs text-[#AAB4D0]/80">
                <Info className="h-4 w-4 shrink-0 text-[#2959FF] mt-0.5" aria-hidden="true" />
                <p>
        ...
        <section className="py-16 sm:py-20">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-2xl border border-[#2959FF]/30 bg-gradient-to-b from-[#11182D] to-[#080D1D] p-8 sm:p-12 relative overflow-hidden">
              <div className="max-w-3xl">
                <h3 className="text-xl font-extrabold text-[#FFF9EE] sm:text-2xl lg:text-3xl">
                ...
                <div className="mt-8 flex flex-wrap items-center gap-4">
                  <Link
                    href="/tools"
                    className="inline-flex items-center gap-2 rounded-lg bg-[#2959FF] px-5 py-2.5 text-xs font-semibold text-white shadow-lg shadow-[#2959FF]/25 hover:bg-[#1E46D9] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2959FF]"
                  >
                  ...
                  <Link
                    href="/"
                    className="inline-flex items-center gap-2 rounded-lg border border-[#273352] bg-[#11182D] px-5 py-2.5 text-xs font-semibold text-[#FFF9EE] hover:border-[#2959FF]/50 hover:bg-[#16213D] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2959FF]"
                  >
