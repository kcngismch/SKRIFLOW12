...
const PLATFORMS = [
  ...
  },
  {
    ...
    color: "text-[#FF6F61]",
    bg: "bg-[#FF6F61]/10",
    border: "border-[#FF6F61]/30",
  },
];

export const CompatibilityStrip: React.FC = () => {
  return (
    <section className="relative border-b border-[#273352] py-12 bg-[#0D1426]/50">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          <h3 className="text-xs font-bold uppercase tracking-wider text-[#AAB4D0]">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-bold text-[#FFF9EE]">
                      {platform.name}
                    </span>
                  </div>
                  <span className="mt-1 text-[11px] text-[#AAB4D0]">
          ...
          <p className="mt-5 text-[11px] text-[#AAB4D0]/60 max-w-md">
